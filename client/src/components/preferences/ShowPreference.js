          ...
          <div className="edit_details">
            ...
            <p>
              ...
              <input
                ...
                min={minStartDate}
                max={maxStartDate}
                defaultValue={moment(preferences.start_date).format(
                  "YYYY-MM-DD"
                )}
                onChange={(e) => {
            ...
            <p>
              ...
              <input
                ...
                min={minFinishtDate}
                max={maxFinishDate}
                defaultValue={moment(preferences.finish_date).format(
                  "YYYY-MM-DD"
                )}
                onChange={(e) => {
            ...
            <button onClick={updatePreference} className="interactionButton">
              Save
            </button>
            <button
              className="interactionButton"
